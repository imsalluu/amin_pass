    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Icon(active ? activeIcon : icon, color: active ? activeColor : inactiveColor, size: 24),
        ),
        if (active)
          Padding(
            padding: const EdgeInsets.only(top: 4),
            child: Text(label, style: TextStyle(color: activeColor, fontSize: 12, fontWeight: FontWeight.w500)),
          ),
      ],
    );
  }
