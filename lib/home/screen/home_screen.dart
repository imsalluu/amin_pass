        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Points Card (rounded, light-blue)
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    // circular percent indicator (built from CircularProgressIndicator)
                    SizedBox(
                      height: 72,
                      width: 72,
                      child: Stack(
                        ...
                        Expanded(
                          child: ClipRRect(
                            ...
                            child: LinearProgressIndicator(
                              ...
                              valueColor:
                              const AlwaysStoppedAnimation(Color(0xff7AA3CC)),
                            ),
                          ),
                        ),
              ...
              // Recent activity list (use Expanded List area)
              Expanded(
                child: ListView(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 60), // space above bottom nav
                  ],
                ),
              ),
            ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(date, style: const TextStyle(color: Colors.black, fontSize: 12)),
              ],
            ),
          ),
        ],
